  ...
  return (
    <div style={{ overflow: "hidden" }}>
      ...
      <div className="side-content-wrapper">
        <div
          className="side-bar-ex-wrapper"
          style={{ position: "fixed", top: "4.8rem", zIndex: "1" }}
        >
          <ExerciseSideBar onMuscleSelect={handleMuscleSelect} />
        </div>
        <div
          className="exercises-container"
          style={{ marginLeft: "7rem", marginTop: "5rem", zIndex: "0" }}
        >
          {isLoading ? (
            ...
            <>
              ...
              <nav>
                <ul className="pagination">
                  {[
                    ...Array(
                      Math.ceil((data?.length || 0) / exercisesPerPage)
                    ).keys(),
                  ].map((number) => (
